...
public class POCValues {
    ...
    public POCValues(Context context) {
        ...
        NAUSEA_VOMITING_DIARRHEA = mContext.getString(R.string.nausea_vomiting);
...
//        pocMap.put(DEFAULT_CHOICE, new ArrayList<String>());
        ...
        shortnessBreath.add(IV_THERAPY);
        ...
        eye_prob.add(MEDICAL_EVALUATION);
        ...
        ingestion.add(MEDICAL_EVALUATION);
        ingestion.add(EKG);
        ingestion.add(CBC);
        ingestion.add(BMP);
        ingestion.add(CMP);
        ...
        rapid.add(IV_THERAPY);
        rapid.add(IV_FLUID);
        rapid.add(URINALYSIS);
        rapid.add(CHEST_X_RAY);
        rapid.add(CT_SCAN);
        rapid.add(STRESS_TEST);
        rapid.add(ECHO);
        rapid.add(HOLTER_MONITOR);
        ...
        respiratory.add(MEDICAL_EVALUATION);
        respiratory.add(EKG);
